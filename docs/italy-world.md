...
**45 accepted, 1 rejected; after one regeneration on 2026-09-21 that picture is rejected again, so one picture is still outstanding.** The reject is a portrait whose first discovery subject fell outside the phone band; its regeneration brought the subject inside the band and cut the artichokes as asked, but lifted the crab cage out of the water onto dry paving and emptied it of visible crabs, which is a new fault in the same subject, so it is sent back a second time. Three portraits delivered one pixel short (941 x 1671) are accepted: the importer pads a shortfall of at most 2 px to the exact target by replicating the last row or column, so all three now land at 941 x 1672. Nothing was rejected on taste.
...
**Owner rulings, 2026-09-21.** Only `it08_laguna_portrait.png` is regenerated, and it is **still outstanding**: the second-round picture arrived on 2026-09-21 at 941 x 1672, was imported over `public/scenes/it_laguna/portrait.jpg` and rejected again for lifting the crab cage out of the canal, so Stage B pictures are not yet closed and no coordinate should be measured on that portrait. The three short portraits (`it06_pescaria_portrait.png`, `it11_ballaro_portrait.png`, `it13_tonnara_portrait.png`) are padded by the importer rather than regenerated. The sweeter faces across all thirteen rooms are accepted as within the house style. The pasticceria card text must not name martorana, because the fruit beside the pastry tube is a real fig, not one of the painted marzipan fruits the brief asked for.
