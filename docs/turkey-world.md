...
The follow-up animation pass adds continuous movement to all fifteen Turkish rooms. Small feathered cutouts from the original JPEG let painted foliage sway; they are cached per room and composition. Lamps shimmer locally, sea glints travel, window rain descends, leaves fall, flour drifts and broader banks of mist cross the distant tea hills. People and architecture remain fixed. The shared painting engine now opens with established steam and animates lamp and fire intensity automatically, including in the Chinese rooms. Portrait cutouts follow the SVG's actual aspect-preserving crop, including wider tablets.
