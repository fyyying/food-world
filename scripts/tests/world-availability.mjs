...
try {
  ...
  assert.deepEqual(worlds.filter(id=>isWorldAvailable(id,true)),['italy','central-europe','mediterranean','middle-east','china'],'the public page exposes only completed worlds');
