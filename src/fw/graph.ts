...
export const INDIA_OBJECTS: WorldObject[] = [
  ...
  { id: "spicesIn", world: "india", kind: "flavour", name: "Spices", zh: "मसाला", emoji: "🌶️", area: "kerala", pos: [16, 15.3], prop: "spiceGarden", rot: 0.05,
  ...
  { id: "southKitchen", world: "india", kind: "technique", name: "Coconut curry & the tawa", zh: "കറി", emoji: "🥥", area: "kerala", pos: [17.5, 2.5], prop: "keralaKitchen", rot: 0.1, place: true, placeName: "Kerala kitchen",
  ...
  { id: "dabbawala", world: "india", kind: "landmark", name: "Dabbawalas", zh: "डब्बावाला", emoji: "🚲", area: "mumbai", pos: [8, 13], prop: "dabbawalas", rot: -0.3,
  ...
  { id: "nets", world: "india", kind: "landmark", name: "Chinese fishing nets", zh: "ചീനവല", emoji: "🎣", area: "kerala", pos: [13, 21.3], prop: "fishingNets", rot: Math.PI,
