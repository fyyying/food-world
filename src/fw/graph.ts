...
export const AREAS: Record<Area, AreaInfo> = {
  ...
  sicily: { world: "italy", name: "Sicily", zh: "Sicilia", blurb: "Etna, lemons, tomatoes and street food", center: [10, 14] },
};
...
export const ITALY_OBJECTS: WorldObject[] = [
  // --- ingredients ---
  { id: "tomato", world: "italy", kind: "ingredient", name: "Tomatoes", zh: "Pomodori", emoji: "🍅", area: "sicily", pos: [-2, 16], prop: "tomatoField", rot: 0.2,
  ...
  { id: "cheese", world: "italy", kind: "ingredient", name: "Cheese", zh: "Formaggio", emoji: "🧀", area: "rome", pos: [-6, -14], prop: "dairy", rot: -0.3,
  ...
  { id: "basil", world: "italy", kind: "flavour", name: "Basil & herbs", zh: "Basilico", emoji: "🌿", area: "rome", pos: [-6, 8], prop: "herbGarden", rot: 0.2,
  ...
  { id: "italyBeef", world: "italy", kind: "ingredient", name: "Beef & pork", zh: "Carne", emoji: "🐄", area: "rome", pos: [-24, -14], prop: "cow", rot: 0.5,
  ...
  { id: "lemon", world: "italy", kind: "ingredient", name: "Lemons & citrus", zh: "Limoni", emoji: "🍋", area: "sicily", pos: [20, 20], prop: "citrusGrove", rot: -0.2,
  ...
  { id: "sicilyMarket", world: "italy", kind: "place", name: "Ballarò street market", zh: "Mercato di Ballarò", emoji: "🍋", area: "sicily", pos: [10, 12], prop: "sicilyMarket", rot: 0, place: true, open: "reveal",
  ...
  { id: "stall-lemon", world: "italy", kind: "ingredient", name: "Lemons & citrus", zh: "Limoni", emoji: "🍋", area: "sicily", pos: [6, 10], prop: "none", hitOnly: true, parent: "sicilyMarket", alias: "lemon", tagline: "", blurb: "", match: () => false },
  { id: "stall-tomato2", world: "italy", kind: "ingredient", name: "Tomatoes", zh: "Pomodori", emoji: "🍅", area: "sicily", pos: [14, 10], prop: "none", hitOnly: true, parent: "sicilyMarket", alias: "tomato", tagline: "", blurb: "", match: () => false },
  { id: "stall-arancini", world: "italy", kind: "dish", name: "Street food", zh: "Cibo di strada", emoji: "🍙", area: "sicily", pos: [10, 8.5], prop: "none", hitOnly: true, parent: "sicilyMarket",
