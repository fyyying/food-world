 ...
 *
 *  Positions are the re-cluster pass of 2026-09-23 (docs/london-world.md, "Re-cluster pass"), which replaced
 *  the shared-ground pass's spread: the twenty-nine stand in six compact clusters (`LONDON_CLUSTERS` below),
 *  each on its own ground tint, with open country or water between them. Every stand still has its own
 *  ground (a unit of clear footprint from every other stand), nothing stands over water but the two bridges
 *  and the oyster smacks, and every clickable is first on all ten of its arrival rays. Ids, kinds, props, scenes, names and purposes are the
...
const rooms: Room[] = [
  {
    ...
    pos: W(-67.31, -4.86), rot: 0, prop: "pub", scene: "uk_pub", placeName: "Public house",
  ...
  },
  {
    ...
    pos: W(-56.64, -4.57), rot: 0, prop: "teaRoom", scene: "uk_tearoom", placeName: "Tea room",
  ...
  },
  {
    ...
    pos: W(-65.87, 3.28), rot: 0, prop: "boroughMarket", scene: "uk_market", placeName: "Borough Market",
  ...
  },
  {
    ...
    pos: W(-38.6, 13.5), rot: 0, prop: "pieShop", scene: "uk_piemash", placeName: "Pie and mash shop",
  ...
  },
  {
    ...
    pos: W(-38.88, -22.29), rot: 0, prop: "chipShop", scene: "uk_chippy", placeName: "Fried fish shop",
  ...
  },
  {
    ...
    pos: W(-54.32, 21), rot: 0, prop: "coffeeStall", scene: "uk_breakfast", placeName: "Coffee stall",
  ...
  },
  {
    ...
    pos: W(-52.05, 13), rot: 0, prop: "lascarKitchen", scene: "uk_lascar", placeName: "Seamen's kitchen",
  ...
  },
  {
    ...
    pos: W(-47.86, 1.89), rot: 0, prop: "hopCookhouse", scene: "uk_hopkitchen", placeName: "Hop-pickers' cookhouse",
  ...
  },
  {
    ...
    pos: W(-44.95, -22.6), rot: 0, prop: "daleDairy", scene: "uk_dairy", placeName: "Dale dairy",
  ...
  },
  {
    ...
    pos: W(-77.3, 18.91), rot: 0, prop: "pastyBakehouse", scene: "uk_pasty", placeName: "Cornish bakehouse",
  ...
  },
  {
    ...
    pos: W(-69.6, 13.1), rot: 0, prop: "cockleStall", scene: "uk_cockles", placeName: "Cockle stall",
  ...
  },
  {
    ...
    pos: W(-75.78, -22.49), rot: 0, prop: "smokehouse", scene: "uk_smokehouse", placeName: "Curing yard",
  ...
  },
  {
    ...
    pos: W(-69.09, -22.62), rot: 0, prop: "distillery", scene: "uk_distillery", placeName: "Distillery",
...
/** The six clusters of Britain, re-laid on 2026-09-23 after the owner's live walkthrough (docs/london-world.md,
 *  "Re-cluster pass"). The shared-ground pass had spread them to find every stand its own ground, and the owner
 *  could not see them: "in China, regions are nicely clustered and separated". Each cluster is one place with one
 *  ground tint, every one of its objects within `radius` of `centre` (the smallest circle round its anchors, to a
 *  tenth), and open country, water or both between it and the next. `london-world.mjs` holds the rule: no object
 *  outside its cluster's radius, no object inside another cluster's hull, and the hulls of the anchors at least
 *  8 apart. `london-landscape.ts` lays each tint from this table. */
export type LondonCluster = { id: string; name: string; centre: [number, number]; radius: number; tint: string; ids: string[] };
export const LONDON_CLUSTERS: LondonCluster[] = [
  { id: "westminster", name: "Westminster and the River", centre: W(-66.0, -1.6), radius: 10, tint: "#b8b4ad",
    ids: ["bigBen", "roastPub", "pastryCe", "teaRoomUk", "redBus", "boroughUk", "phoneBox"] },
  { id: "docks", name: "The Docks and the East End", centre: W(-46.6, 17.2), radius: 9, tint: "#a89c86",
    ids: ["towerBridge", "oystersUk", "pieMashUk", "lascarUk", "breakfastUk"] },
  { id: "weald", name: "The Weald", centre: W(-45.4, -2.5), radius: 9, tint: "#6e9a45",
    ids: ["mushroomsCe", "hopsUk", "hopKitchenUk"] },
  { id: "dales", name: "The Dales and the Mill Towns", centre: W(-43.2, -18.6), radius: 9, tint: "#b4b89a",
    ids: ["dairyUk", "chippyUk", "sheepUk", "rhubarbUk"] },
  { id: "westCountry", name: "The West Country and the Bristol Channel", centre: W(-69.0, 17.1), radius: 9, tint: "#a99a74",
    ids: ["cocklesUk", "engineHouseUk", "pastyUk", "leeksUk", "orchardUk"] },
  { id: "firths", name: "The Firths and the Herring Coast", centre: W(-67.6, -20.8), radius: 9, tint: "#8c9a86",
    ids: ["smokehouseUk", "distilleryUk", "forthBridge", "herringUk", "oatsUk"] },
];
...
LONDON_OBJECTS.push(
  ...
  },
  {
    ...
    area: "london", pos: W(-40.46, -3.23), rot: 0, elevation: 0, prop: "hopGarden",
  ...
  },
  {
    ...
    area: "london", pos: W(-48.38, -6.49), rot: 0, elevation: 0, prop: "mushroomWood",
  ...
  },
  {
    ...
    area: "london", pos: W(-47.77, -15.33), rot: 0, elevation: 0, prop: "daleFlock",
  ...
  },
  {
    ...
    area: "london", pos: W(-38.92, -14.57), rot: 0, elevation: 0, prop: "forcingShed",
  ...
  },
  {
    ...
    area: "london", pos: W(-62.55, 21.6), rot: 0, elevation: 0, prop: "ciderOrchard",
  ...
  },
  {
    ...
    area: "london", pos: W(-70.2, 22.09), rot: 0, elevation: 0, prop: "leekBed",
  ...
  },
  {
    ...
    area: "london", pos: W(-62.05, -16.12), rot: 0, elevation: 0, prop: "oatMill",
  ...
  },
  {
    ...
    area: "london", pos: W(-72.92, -14.39), rot: 0, elevation: 0, prop: "herringQuay",
...
LONDON_OBJECTS.push(
  ...
  },
  {
    ...
    area: "london", pos: W(-59.6, -23.2), rot: 0, elevation: 0, prop: "forthBridge",
  ...
  },
  {
    ...
    area: "london", pos: W(-61.41, 14.16), rot: 0, elevation: 0, prop: "engineHouse",
