...
const rooms: Room[] = [
  {
    ...
    pos: [-67.31, -4.86], rot: 0, prop: "pub", scene: "uk_pub", placeName: "Public house",
  ...
  },
  {
    ...
    pos: [-56.64, -4.57], rot: 0, prop: "teaRoom", scene: "uk_tearoom", placeName: "Tea room",
  ...
  },
  {
    ...
    pos: [-65.87, 3.28], rot: 0, prop: "boroughMarket", scene: "uk_market", placeName: "Borough Market",
  ...
  },
  {
    ...
    pos: [-38.6, 13.5], rot: 0, prop: "pieShop", scene: "uk_piemash", placeName: "Pie and mash shop",
  ...
  },
  {
    ...
    pos: [-38.88, -22.29], rot: 0, prop: "chipShop", scene: "uk_chippy", placeName: "Fried fish shop",
  ...
  },
  {
    ...
    pos: [-54.32, 21], rot: 0, prop: "coffeeStall", scene: "uk_breakfast", placeName: "Coffee stall",
  ...
  },
  {
    ...
    pos: [-52.05, 13], rot: 0, prop: "lascarKitchen", scene: "uk_lascar", placeName: "Seamen's kitchen",
  ...
  },
  {
    ...
    pos: [-47.86, 1.89], rot: 0, prop: "hopCookhouse", scene: "uk_hopkitchen", placeName: "Hop-pickers' cookhouse",
  ...
  },
  {
    ...
    pos: [-44.95, -22.6], rot: 0, prop: "daleDairy", scene: "uk_dairy", placeName: "Dale dairy",
  ...
  },
  {
    ...
    pos: [-77.3, 18.91], rot: 0, prop: "pastyBakehouse", scene: "uk_pasty", placeName: "Cornish bakehouse",
  ...
  },
  {
    ...
    pos: [-69.6, 13.1], rot: 0, prop: "cockleStall", scene: "uk_cockles", placeName: "Cockle stall",
  ...
  },
  {
    ...
    pos: [-75.78, -22.49], rot: 0, prop: "smokehouse", scene: "uk_smokehouse", placeName: "Curing yard",
  ...
  },
  {
    ...
    pos: [-69.09, -22.62], rot: 0, prop: "distillery", scene: "uk_distillery", placeName: "Distillery",
...
export const LONDON_CLUSTERS: LondonCluster[] = [
  { id: "westminster", name: "Westminster and the River", centre: [-66.0, -1.6], radius: 10, tint: "#b8b4ad",
    ids: ["bigBen", "roastPub", "pastryCe", "teaRoomUk", "redBus", "boroughUk", "phoneBox"] },
  { id: "docks", name: "The Docks and the East End", centre: [-46.6, 17.2], radius: 9, tint: "#a89c86",
    ids: ["towerBridge", "oystersUk", "pieMashUk", "lascarUk", "breakfastUk"] },
  { id: "weald", name: "The Weald", centre: [-45.4, -2.5], radius: 9, tint: "#6e9a45",
    ids: ["mushroomsCe", "hopsUk", "hopKitchenUk"] },
  { id: "dales", name: "The Dales and the Mill Towns", centre: [-43.2, -18.6], radius: 9, tint: "#b4b89a",
    ids: ["dairyUk", "chippyUk", "sheepUk", "rhubarbUk"] },
  { id: "westCountry", name: "The West Country and the Bristol Channel", centre: [-69.0, 17.1], radius: 9, tint: "#a99a74",
    ids: ["cocklesUk", "engineHouseUk", "pastyUk", "leeksUk", "orchardUk"] },
  { id: "firths", name: "The Firths and the Herring Coast", centre: [-67.6, -20.8], radius: 9, tint: "#8c9a86",
...
LONDON_OBJECTS.push(
  {
    ...
    area: "london", pos: [-62.27, -3.27], rot: 0, elevation: 0, prop: "bakeryCe",
  ...
  },
  {
    ...
    area: "london", pos: [-44.85, 11.5], rot: -0.1, elevation: 0, prop: "oysterSmack",
  ...
  },
  {
    ...
    area: "london", pos: [-40.46, -3.23], rot: 0, elevation: 0, prop: "hopGarden",
  ...
  },
  {
    ...
    area: "london", pos: [-48.38, -6.49], rot: 0, elevation: 0, prop: "mushroomWood",
  ...
  },
  {
    ...
    area: "london", pos: [-47.77, -15.33], rot: 0, elevation: 0, prop: "daleFlock",
  ...
  },
  {
    ...
    area: "london", pos: [-38.92, -14.57], rot: 0, elevation: 0, prop: "forcingShed",
  ...
  },
  {
    ...
    area: "london", pos: [-62.55, 21.6], rot: 0, elevation: 0, prop: "ciderOrchard",
  ...
  },
  {
    ...
    area: "london", pos: [-70.2, 22.09], rot: 0, elevation: 0, prop: "leekBed",
  ...
  },
  {
    ...
    area: "london", pos: [-62.05, -16.12], rot: 0, elevation: 0, prop: "oatMill",
  ...
  },
  {
    ...
    area: "london", pos: [-72.92, -14.39], rot: 0, elevation: 0, prop: "herringQuay",
...
LONDON_OBJECTS.push(
  {
    ...
    area: "london", pos: [-74.87, -4.68], rot: 0, elevation: 0, prop: "bigBen",
  ...
  },
  {
    ...
    area: "london", pos: [-45.2, 20], rot: 0, elevation: 0, prop: "towerBridge",
  ...
  },
  {
    ...
    area: "london", pos: [-75.3, 1.46], rot: 0, elevation: 0, prop: "omnibus",
  ...
  },
  {
    ...
    area: "london", pos: [-59.28, 3.12], rot: 0, elevation: 0, prop: "pillarBox",
  ...
  },
  {
    ...
    area: "london", pos: [-59.6, -23.2], rot: 0, elevation: 0, prop: "forthBridge",
  ...
  },
  {
    ...
    area: "london", pos: [-61.41, 14.16], rot: 0, elevation: 0, prop: "engineHouse",
