 ...
 *
 *  Positions and rotations are the fixed Stage B blueprint in docs/london-world.md; ids, kinds, props,
 *  scenes, names and purposes are the object list in the same document. Twenty-nine objects: thirteen that
 *  open a painted room, ten card-only ingredient and flavour stops, and six landmarks with a card and a 3D
 *  reaction. `londonEye` is retired and is not here; `redBus` and `phoneBox` keep their ids and are recast
 *  onto the 1907 omnibus with the hansom cab and onto the 1852 pillar box with the lamp; `roastPub` keeps
 *  its id, its `place` flag and the Beef Wellington recipe target, and is renamed "The public house",
 *  because a self-service carvery counter is a post-war restaurant format.
 *
 *  Rotation. `prop.rotation.y = obj.rot` (worldkit.ts), so `rot` is atan2(dx, dz) toward the point the
 *  stand faces, which is Spain's convention. Every object faces the nearest point of the road network
 *  when a road passes within 2.5 units of it - the definition of done requires every door to meet a road -
 *  and otherwise the nearest water. Five objects whose subject is the water face the water whatever the
 *  road does: `oystersUk` (smacks moored at the river mouth), `towerBridge` (built to stand in the
 *  estuary), `forthBridge` (its span reaches over the firth), `cocklesUk` (the stall works the sand) and
 *  `herringUk` (the quay). Roads, river and coast ring are the tables in the Stage B blueprint.
 *
...
const rooms: Room[] = [
  ...
  },
  {
    ...
    pos: [-54.4, -7.1], rot: 0, prop: "teaRoom", scene: "uk_tearoom", placeName: "Tea room",
  ...
  },
  {
    ...
    pos: [-47.6, -7.1], rot: 0, prop: "boroughMarket", scene: "uk_market", placeName: "Borough Market",
  ...
  },
  {
    ...
    pos: [-42.8, 9.65], rot: 3.14, prop: "pieShop", scene: "uk_piemash", placeName: "Pie and mash shop",
  ...
  },
  {
    ...
    pos: [-58, -10.1], rot: -1.71, prop: "chipShop", scene: "uk_chippy", placeName: "Fried fish shop",
  ...
  },
  {
    ...
    pos: [-40.1, 9.65], rot: 3.04, prop: "coffeeStall", scene: "uk_breakfast", placeName: "Coffee stall",
  ...
  },
  {
    ...
    pos: [-37.4, 10.3], rot: -3.03, prop: "lascarKitchen", scene: "uk_lascar", placeName: "Seamen's kitchen",
  ...
  },
  {
    ...
    pos: [-43.65, 13.35], rot: -1.68, prop: "hopCookhouse", scene: "uk_hopkitchen", placeName: "Hop-pickers' cookhouse",
  ...
  },
  {
    ...
    pos: [-56.9, -13.1], rot: -2.08, prop: "daleDairy", scene: "uk_dairy", placeName: "Dale dairy",
  ...
  },
  {
    ...
    pos: [-74.1, 7.1], rot: -1.05, prop: "pastyBakehouse", scene: "uk_pasty", placeName: "Cornish bakehouse",
  ...
  },
  {
    ...
    pos: [-69.4, 14.5], rot: -1.72, prop: "cockleStall", scene: "uk_cockles", placeName: "Cockle stall",
  ...
  },
  {
    ...
    pos: [-62.1, -23.7], rot: -0.28, prop: "smokehouse", scene: "uk_smokehouse", placeName: "Curing yard",
  ...
  },
  {
    ...
    pos: [-66.1, -20.9], rot: 3.06, prop: "distillery", scene: "uk_distillery", placeName: "Distillery",
...
LONDON_OBJECTS.push(
  ...
  },
  {
    ...
    area: "london", pos: [-41.5, 17.5], rot: -1.47, elevation: 0, prop: "hopGarden",
  ...
  },
  {
    ...
    area: "london", pos: [-46.8, 20.2], rot: 1.93, elevation: 0, prop: "mushroomWood",
  ...
  },
  {
    ...
    area: "london", pos: [-61.5, -12.5], rot: 1.42, elevation: 0, prop: "daleFlock",
  ...
  },
  {
    ...
    area: "london", pos: [-55, -16], rot: -1.49, elevation: 0, prop: "forcingShed",
    tagline: "Grown in the dark, pulled by candlelight, and on the night train to London.",
    blurb: "A long low shed with no windows, warm inside, and rows of rhubarb crowns growing in complete darkness. Forcing began in Yorkshire in 1877 and turned a field crop into a winter luxury. The roots are grown outdoors for two years to build up sugar, lifted after a frost has done its work on them, and moved into the heated shed, where they grow on nothing but what they stored.\n\nWorking from its own reserves, with no light to make more, the plant sends up stems long, smooth and deep pink-red, sharper and cleaner than anything grown outside. The sheds are worked by candlelight, because stronger light would green the stems and toughen them.\n\nWhat it was grown for was the city. The Great Northern ran a nightly rhubarb express from Ardsley through the season, so that what was pulled in the dark in the West Riding was on a London barrow the next morning. The Rhubarb Triangle once ran to nine square miles of these sheds; Yorkshire Forced Rhubarb was given a protected designation of origin in 2010.",
