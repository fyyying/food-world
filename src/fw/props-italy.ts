...
export const ITALY_ICONS: Record<string, () => P> = {
  ...
  riceIt: () => { const g = group(); add(g, cyl(0.42, 0.28, 0.32, "#f7f2e6", 12), 0, 0.16, 0); add(g, ball(0.38, "#f4ecc8", 9), 0, 0.36, 0).scale.y = 0.45; for (let i = 0; i < 6; i++) add(g, ball(0.03, "#e0a52c", 5), (rnd() - 0.5) * 0.4, 0.5, (rnd() - 0.5) * 0.4); return g; },
