...
import { C, add, box, cyl, cone, ball, group, reaction, pick, tickChildren, smooth, mat, house, person, lantern, chineseRoof, pavilionRoof, terrace, bubble, rnd, type P } from "./props";
