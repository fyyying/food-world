...
export type Chapter = {
  era: string;
  title: string;
  /** the title in the language of the place this chapter stops at (Chinese only for Chinese stops) */
  zh?: string;
  text: string;
  stop: StoryStop;
};
...
export type Story = {
  ...
  emoji: string;
  title: string;
  /** the title in the language of where the story ends */
  zh: string;
  tagline: string;
  chapters: Chapter[];
};
...
export const STORIES: Story[] = [
  {
    ...
    chapters: [
      {
        era: "6000 BC · Mexico", title: "A wild berry in the Tehuacán valley", zh: "Chīlli", stop: { region: "mexico" },
      ...
      {
        era: "1493 · Spain", title: "Columbus mistakes it for pepper", zh: "Pimiento", stop: { region: "mediterranean" },
      ...
      {
        era: "1510s · India", title: "The Portuguese carry it east", zh: "मिर्च", stop: { region: "india" },
  ...
  },
  {
    ...
    chapters: [
      {
        era: "700 AD · Mexico", title: "Tomatl in the Aztec market", zh: "Tomatl", stop: { region: "mexico" },
      ...
      {
        era: "1540s · Spain", title: "A golden apple for the garden", zh: "Pomi d'oro", stop: { region: "mediterranean" },
      ...
      {
        era: "1692 · Naples", title: "The first tomato sauce", zh: "Salsa di pomodoro", stop: { region: "italy", dist: 40 },
      ...
      {
        era: "1889 · Naples", title: "Pizza in the colours of the flag", zh: "Pizza Margherita", stop: { region: "italy", dist: 40 },
      ...
      {
        era: "Today · Sicily", title: "Red gold on the roofs", zh: "U strattu", stop: { world: "italy", object: "tomato" },
  ...
  },
  {
    ...
    chapters: [
      {
        era: "8000 years ago · The Andes", title: "Bred on the roof of the world", zh: "Papa", stop: { region: "mexico" },
      ...
      {
        era: "1570 · Spain", title: "Ship's stores in Seville", zh: "Patatas en Sevilla", stop: { region: "mediterranean" },
      ...
      {
        era: "1756 to 1785 · Prussia and France", title: "Kings talk Europe into it", zh: "Kartoffelbefehl", stop: { region: "central-europe" },
      ...
      {
        era: "1845 · Ireland", title: "One crop, one blight", zh: "An Gorta Mór", stop: { region: "central-europe" },
      ...
      {
        era: "Today · China", title: "The world's biggest potato field", zh: "洋芋", stop: { region: "china" },
  ...
  },
  {
    ...
    chapters: [
      ...
      {
        era: "1191 · Japan", title: "A monk brings seeds home", zh: "栄西と茶", stop: { region: "japan" },
      ...
      {
        era: "1600s · Persia and Turkey", title: "The caravan roads", zh: "چای", stop: { region: "middle-east" },
      ...
      {
        era: "1657 · London", title: "From the coffeehouse to the afternoon", stop: { region: "central-europe" },
      ...
      {
        era: "1830s · Assam", title: "The British plant their own", zh: "चाय", stop: { region: "india" },
      ...
      {
        era: "1850s · Morocco", title: "Green tea meets mint", zh: "أتاي", stop: { region: "mediterranean" },
  ...
  },
  {
    ...
    chapters: [
      {
        era: "1400s · Yemen", title: "The monks of Mocha stay awake", zh: "قهوة المخا", stop: { region: "middle-east" },
      ...
      {
        era: "1554 · Istanbul", title: "The schools of the wise", zh: "Kahvehane", stop: { region: "middle-east" },
      ...
      {
        era: "1615 · Venice", title: "The Devil's drink is baptised", zh: "Il caffè", stop: { region: "italy" },
      ...
      {
        era: "1652 · London", title: "Penny universities", stop: { region: "central-europe" },
      ...
      {
        era: "1696 to 1727 · Java and Brazil", title: "Smuggled seedlings", zh: "Café", stop: { region: "southeast-asia" },
      ...
      {
        era: "1901 to today · Italy", title: "The espresso bar", zh: "Espresso", stop: { world: "italy", object: "gelateria" },
  ...
  },
  {
    ...
    chapters: [
      {
        era: "9000 years ago · Mexico", title: "A grass called teosinte", zh: "Teocintle", stop: { region: "mexico" },
      ...
      {
        era: "1493 · Spain", title: "Columbus brings it home", zh: "Maíz", stop: { region: "mediterranean" },
      ...
      {
        era: "1500s · Africa", title: "The Portuguese coast", zh: "Ugali", stop: { region: "mediterranean", dist: 60 },
      ...
      {
        era: "1500s · India", title: "Around the Cape to Goa", zh: "मक्का", stop: { region: "india" },
      ...
      {
        era: "Today · The milpa", title: "Home to Oaxaca", zh: "La milpa", stop: { world: "mexico", object: "corn" },
  ...
  },
  {
    ...
    chapters: [
      {
        era: "1st century · Kerala", title: "Black gold on the Malabar coast", zh: "കുരുമുളക്", stop: { region: "india" },
      ...
      {
        era: "700 to 1400 · Arabia", title: "The middlemen of the incense road", zh: "طريق البخور", stop: { region: "middle-east" },
      ...
      {
        era: "1200s · Venice", title: "The Venetian monopoly", zh: "Il monopolio", stop: { region: "italy" },
      ...
      {
        era: "1498 · Around the Cape", title: "Vasco da Gama reaches Calicut", zh: "Vasco da Gama", stop: { region: "mediterranean" },
      ...
      {
        era: "1600s · The Spice Islands", title: "Nutmeg and the Dutch", zh: "Kepulauan Rempah", stop: { region: "southeast-asia" },
      ...
      {
        era: "Today · The bazaar", title: "The Spice Bazaar of Istanbul", zh: "Mısır Çarşısı", stop: { world: "middle-east", object: "spicesMe" },
