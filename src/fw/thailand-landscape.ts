...
export const TH_ROADS: Road[] = [
  ...
  { id: 'TH-R1', width: 2.2, points: [[-39.1, -9.6], [-38.6, -4.6], [-38.4, 0.4], [-36, 3.5], [-36.8, 9.6], [-37.5, 13.5], [-36.9, 17.4], [-36.3, 20.4]] },
  ...
  { id: 'TH-R3', width: 2.4, points: [[-38.6, -4.6], [-36.4, -8.4], [-33.6, -9.1], [-30.8, -7.6], [-28.4, -6.8], [-26.5, -6.5], [-24.2, -4.6]] },
  { id: 'TH-R3b', width: 1.8, points: [[-30.8, -7.6], [-25.4, 4.4], [-21.3, 8], [-20.2, 13.3]] },
  { id: 'TH-R4', width: 1.8, points: [[-38.4, 0.4], [-42.5, -2.4], [-45, -5.4], [-48, -6.2], [-51.8, -6.8], [-53, -7.6], [-56.4, -9.4], [-60.4, -8.8], [-68.4, -14.4], [-60.8, -15.4], [-57.6, -16.6], [-54, -16.6], [-54.4, -19]] },
  { id: 'TH-R5', width: 1.6, points: [[-54.4, -19], [-55.4, -19.8], [-57.2, -22.2], [-59.4, -24.6], [-63.2, -23.4], [-64, -20.6]] },
  { id: 'TH-R6', width: 1.6, points: [[-24.2, -4.6], [-27.7, -9.1], [-26.6, -13.5], [-27, -19.1], [-25.1, -20.8], [-20.7, -20.3]] },
