 ...
 *  ferries, walkers or farmland. The table is **W 106, D 112, cx -50, cz 10** (grown from W 68 x D 88 on the lead's QC so the sea is wide round the headlands): the island has all of it, and its six
...
export function buildCeurope(recipes: EnrichedRecipe[]): Diorama {
  return buildWorld({
    id: "central-europe", W: 106, D: 112, cx: -50, cz: 10, ground: "#8fb56a", plinth: "#5a4a3a", recipes,
