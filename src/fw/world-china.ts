...
function layoutChina({ group, tickers, place, tint, TOP }: LayoutCtx) {
  ...
  for (const [kind, x, z, rot] of [["cabbageStack", 26.2, -12.4, -0.4], ["garlicBraids", 12.6, -27.2, 0.2], ["chilliStrings", 2.4, -25.6, 0], ["chilliStrings", 41.2, -22.6, 0.3], ["noodleRack", 31.2, -16.9, 0.1], ["wheatSheaves", -4.4, -25.4, 0.3], ["wheatSheaves", -16.4, -24.6, -0.2], ["coalStack", 16.2, -11.6, 0.2], ["pickleCrocks", 29.4, -12.4, 0.1], ["persimmonString", 20.4, -12.2, 0], ["cornCrib", 17.2, -19.4, 0.3], ["stoneMill", 24.5, -24.5, 0], ["flourSacks", 33.5, -30.5, 0.4], ["pickleCrocks", 13.2, -30.6, -0.3], ["coalStack", 3.0, -32.6, 0.5]] as [Parameters<typeof northDetail>[0], number, number, number][]) place(northDetail(kind), x, z, rot);
