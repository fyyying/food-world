    ...
    beats: [
      {
        ...
        body: "Rice fields, deltas, canals and coasts shape everyday food. Rice becomes noodles, paper, porridge and the centre of a meal, while waterways bring fish and market produce.",
        emoji: "🌾",
      ...
      },
      {
        ...
        body: "Herbs, lime, chillies, fermented sauces, coconut and crisp vegetables create contrast. Sour, salty, sweet, bitter and hot notes are adjusted for a dish and for the person eating it.",
        emoji: "🌿",
        areas: ["hanoi", "andaman"],
      },
      {
        ...
        body: "Bangkok, the Andaman coast, Hanoi and the Mekong delta reveal different street, home and waterside kitchens. The wider region holds many more cuisines still to explore.",
        emoji: "🛶",
        areas: ["bangkok", "andaman", "hanoi", "mekong"],
      },
    ],
  },
  "north-america": {
