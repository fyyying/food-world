...
export const WORLD_INTROS: Record<WorldId, WorldIntro> = {
  ...
  italy: {
    summary: "A country assembled in 1861, seen from three of its kitchens: Rome's fifth quarter, the Venetian lagoon and the tables of Palermo and the tuna coast.",
    accent: "#7b943f",
    beats: [
      {
        eyebrow: "A new country, about 1880 to 1914",
        title: "Younger than it looks",
        body: "Italy is a few decades old here, and so is much of its food. The first book to gather recipes from every region between two covers was self-published in Florence in 1891. Carbonara, tiramisù and the spritz are all later; what a table carries now is bread, pulses, offal, polenta and whatever the season is cutting.",
        emoji: "📖",
        areas: ["rome", "venice", "sicily"],
      },
      {
        eyebrow: "Rome · Roma",
        title: "The fifth quarter, and the artichoke",
        body: "Four quarters of the carcass went to paying customers; the fifth — tail, tripe, trotters — stayed in Testaccio, where the slaughterhouse opened around 1890, and became a cuisine. Up the river, a market has traded on Campo de' Fiori since 1869, a wood oven bakes the quarter's bread and a long white pizza, and a farm on the Agro Romano makes pecorino cold.",
        emoji: "🍲",
        areas: ["rome"],
      },
      {
        eyebrow: "Venice · Venezia",
        title: "Wet marble, a half glass, and polenta",
        body: "The fish market has stood at the Rialto since 1097, under a plain iron canopy built in 1884. Next to it an osteria pours half a glass of wine for a man who drinks it standing. Out in the lagoon a Burano house lives off a crab that moults for a fortnight — and behind it the maize plain eats polenta and little else.",
        emoji: "🐟",
        areas: ["venice"],
      },
      {
        eyebrow: "Sicily · Sicilia",
        title: "Fried standing up, and sold overseas",
        body: "In Palermo's Albergheria a pan of lard turns chickpea flour and spleen into what the quarter eats in the street, and Ballarò sells swordfish under awnings with the prices sung. On the coast, lemons, capers and almonds are grown for export, and a tuna works boils, tins and oils one fish while the island's people leave.",
        emoji: "🍋",
        areas: ["sicily"],
      },
    ],
  ...
  "central-europe": {
    summary: "One island, about 1880 to 1914: the river and the docks of London, the Weald, the Dales, the West Country and the Scottish firths, each parted by hills, moor or water.",
    accent: "#668061",
    beats: [
      {
      ...
      },
      {
        ...
        body: "Public houses, tea rooms, market halls and coffee stalls turn food into social space. Hospitality may be formal or everyday, but the meal often carries local memory - and a tea room was one of the few public rooms a woman could sit down in alone.",
        emoji: "🕯️",
        areas: ["london"],
      },
      {
        ...
        body: "The island is drawn to be read, not to be measured: Scotland lies north and Cornwall south-west, but the distances are the table's own. Each region keeps its own history and voice.",
        emoji: "🧭",
        areas: ["london"],
      },
    ],
