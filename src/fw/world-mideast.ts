...
function layoutMideast({ group, tickers, place, tint, TOP }: LayoutCtx) {
  ...
  const bosphorus = new THREE.CatmullRomCurve3([new THREE.Vector3(14, 0, -28), new THREE.Vector3(14, 0, -26.6), new THREE.Vector3(8, 0, -26), new THREE.Vector3(0, 0, -24), new THREE.Vector3(-8, 0, -22), new THREE.Vector3(-16, 0, -20), new THREE.Vector3(-24, 0, -19), new THREE.Vector3(-32, 0, -18), new THREE.Vector3(-36.5, 0, -17.2), new THREE.Vector3(-38, 0, -17.2)]);
  ...
  const zayandeh = new THREE.CatmullRomCurve3([new THREE.Vector3(38, 0, 8), new THREE.Vector3(36.5, 0, 8), new THREE.Vector3(30, 0, 9), new THREE.Vector3(20, 0, 9.5), new THREE.Vector3(12, 0, 11), new THREE.Vector3(8, 0, 14), new THREE.Vector3(6.5, 0, 16)]);
